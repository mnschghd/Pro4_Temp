...
A couple of embedded side-projects living under one roof.

## What's in here

**ESP32S3/** — firmware for an ESP32-S3 that turns into a WiFi file server.  
Flash it onto the board, connect to its network, and you get a browser-based file manager. Drag stuff onto the page, download files, browse around. No cloud, no internet, just a little access point you plug into USB for power.
...
It's useful for testing, debugging HID stuff, or just having a keystroke log without installing software on the host machine.
...
No guarantees, no support. This is tinkering-level stuff.
